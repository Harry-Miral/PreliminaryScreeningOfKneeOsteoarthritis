...
print('Mean Accuracy: {:.6f}, 95% CI: {}'.format(np.mean(accuracys), bootstrap_ci(accuracys)))
print('Mean AUC: {:.6f}, 95% CI: {}'.format(np.mean(auck), bootstrap_ci(auck)))
print('Mean Specificity: {:.6f}, 95% CI: {}'.format(np.mean(specificity), bootstrap_ci(specificity)))
print('Mean Recall: {:.6f}, 95% CI: {}'.format(np.mean(Recalls), bootstrap_ci(Recalls)))
print('Mean Precision: {:.6f}, 95% CI: {}'.format(np.mean(Precisions), bootstrap_ci(Precisions)))
print('Mean F1-Score: {:.6f}, 95% CI: {}'.format(np.mean(F1score), bootstrap_ci(F1score)))
print('Mean Brier Score: {:.6f}, 95% CI: {}'.format(np.mean(brier_scores), bootstrap_ci(brier_scores)))