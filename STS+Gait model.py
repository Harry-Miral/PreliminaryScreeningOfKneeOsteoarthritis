...
adam = Adam(lr=0.00013, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0, amsgrad=False)
...
adam1 = Adam(lr=0.00013, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0, amsgrad=False)
...
adam2 = Adam(lr=0.00013, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0, amsgrad=False)
...
adam3 = Adam(lr=0.00013, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0, amsgrad=False)
...
adam4 = Adam(lr=0.00013, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0, amsgrad=False)
...
adam5 = Adam(lr=0.00013, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0, amsgrad=False)
...
for i in range(5):
    if i == 0:
        ...
        model.fit(x_train, y_train, batch_size=100, epochs=2000, validation_data=(x_test, y_test),
        ...
        model1.fit(x_train, y_train, batch_size=100, epochs=2000, validation_data=(x_test, y_test),
                   callbacks=[early_stopping, lr_reducer])
        ...
        model2.fit(x_train, y_train, batch_size=100, epochs=2000, validation_data=(x_test, y_test),
                   callbacks=[early_stopping, lr_reducer])
        ...
        model3.fit(x_train, y_train, batch_size=100, epochs=2000, validation_data=(x_test, y_test),
                   callbacks=[early_stopping, lr_reducer])
        ...
        model4.fit(x_train, y_train, batch_size=100, epochs=2000, validation_data=(x_test, y_test),
                   callbacks=[early_stopping, lr_reducer])
...
print("\n========== Mean Metrics and Bootstrap 95% CI ==========")
print('Mean Accuracy: {:.3f}, 95% CI: {}'.format(np.mean(accuracys), bootstrap_ci(accuracys)))
print('Mean AUC: {:.3f}, 95% CI: {}'.format(np.mean(auck), bootstrap_ci(auck)))
print('Mean Specificity: {:.3f}, 95% CI: {}'.format(np.mean(specificity), bootstrap_ci(specificity)))
print('Mean Recall: {:.3f}, 95% CI: {}'.format(np.mean(Recalls), bootstrap_ci(Recalls)))
print('Mean Precision: {:.3f}, 95% CI: {}'.format(np.mean(Precisions), bootstrap_ci(Precisions)))
print('Mean F1-Score: {:.3f}, 95% CI: {}'.format(np.mean(F1score), bootstrap_ci(F1score)))
print('Mean Brier Score: {:.3f}, 95% CI: {}'.format(np.mean(brier_scores), bootstrap_ci(brier_scores)))