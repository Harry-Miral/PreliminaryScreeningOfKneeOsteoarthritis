...
print(f"Mean Accuracy: {np.mean(accuracys):.6f}, 95% CI: {bootstrap_ci(accuracys)}")
print(f"Mean AUC: {np.mean(auck):.6f}, 95% CI: {bootstrap_ci(auck)}")
print(f"Mean Specificity: {np.mean(specificity):.6f}, 95% CI: {bootstrap_ci(specificity)}")
print(f"Mean Recall: {np.mean(Recalls):.6f}, 95% CI: {bootstrap_ci(Recalls)}")
print(f"Mean Precision: {np.mean(Precisions):.6f}, 95% CI: {bootstrap_ci(Precisions)}")
print(f"Mean F1-Score: {np.mean(F1score):.6f}, 95% CI: {bootstrap_ci(F1score)}")
print(f"Mean Brier Score: {np.mean(brier_scores):.6f}, 95% CI: {bootstrap_ci(brier_scores)}")