...
adam = Adam(lr=0.00004, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0, amsgrad=False)
...
adam1 = Adam(lr=0.00004, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0, amsgrad=False)
...
adam2 = Adam(lr=0.00004, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0, amsgrad=False)
...
adam3 = Adam(lr=0.00004, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0, amsgrad=False)
...
adam4 = Adam(lr=0.00004, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0, amsgrad=False)
...
adam5 = Adam(lr=0.00004, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0, amsgrad=False)
...
print("\n========== Mean and 95% Confidence Intervals (Bootstrap) ==========")
print(f"Mean Accuracy: {np.mean(accuracys):.3f}, 95% CI: {bootstrap_ci(accuracys)}")
print(f"Mean AUC: {np.mean(auck):.3f}, 95% CI: {bootstrap_ci(auck)}")
print(f"Mean Specificity: {np.mean(specificity):.3f}, 95% CI: {bootstrap_ci(specificity)}")
print(f"Mean Recall: {np.mean(Recalls):.3f}, 95% CI: {bootstrap_ci(Recalls)}")
print(f"Mean Precision: {np.mean(Precisions):.3f}, 95% CI: {bootstrap_ci(Precisions)}")
print(f"Mean F1-Score: {np.mean(F1score):.3f}, 95% CI: {bootstrap_ci(F1score)}")
print(f"Mean Brier Score: {np.mean(brier_scores):.3f}, 95% CI: {bootstrap_ci(brier_scores)}")