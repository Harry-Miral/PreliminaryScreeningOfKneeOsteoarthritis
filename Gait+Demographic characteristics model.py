...
adam = Adam(lr=0.00009, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0, amsgrad=False)
...
adam1 = Adam(lr=0.00009, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0, amsgrad=False)
...
adam2 = Adam(lr=0.00009, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0, amsgrad=False)
...
adam3 = Adam(lr=0.00009, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0, amsgrad=False)
...
adam4 = Adam(lr=0.00009, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0, amsgrad=False)
...
adam5 = Adam(lr=0.00009, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0, amsgrad=False)
...
print("\n========== Mean Metrics and Bootstrap 95% Confidence Intervals ==========")
print(f"Accuracy: {np.mean(accuracys):.6f}, 95% CI: {bootstrap_ci(accuracys)}")
print(f"Precision: {np.mean(Precisions):.6f}, 95% CI: {bootstrap_ci(Precisions)}")
print(f"Recall: {np.mean(Recalls):.6f}, 95% CI: {bootstrap_ci(Recalls)}")
print(f"Specificity: {np.mean(specificity):.6f}, 95% CI: {bootstrap_ci(specificity)}")
print(f"F1-Score: {np.mean(F1score):.6f}, 95% CI: {bootstrap_ci(F1score)}")
print(f"AUC: {np.mean(auck):.6f}, 95% CI: {bootstrap_ci(auck)}")
print(f"Brier Score: {np.mean(brier_scores):.6f}, 95% CI: {bootstrap_ci(brier_scores)}")